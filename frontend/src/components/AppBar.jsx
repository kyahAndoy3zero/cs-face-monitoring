       ...
       <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
            ...
            <h1 className='text-xl font-medium text-gray-900 dark:text-white'>{user.name}</h1>
                    <div className="flex md:order-2">
                        <button type="button" onClick={() => handleModal(<CreateProfile/>)} className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-3" aria-expanded="false">
